                            ...
                            <div class="nav-left">
                                ...
                                <div class="collapse  nav-desk" id="navbarToggleExternalContent">
                                    <ul class="nav-cat title-font">
                                        @foreach (\App\Models\HomeCategory::with('category')->where('published', 1)->get() as $homecategory)
                                            <li>
                                                <a
                                                    href="category-page.html">{{ $homecategory->category->name ?? '' }}</a>
                                            </li>
                                        @endforeach
                                        <li>
                        ...
                        <div class="menu-block">
                            <nav id="main-nav">
                                ...
                                <ul id="main-menu" class="sm pixelstrap sm-horizontal">
                                    ...
                                    <li>
                                        <a class="dark-menu-item" href="newproducts.html">أحدث المنتجات</a>
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <ul>
                                            @foreach (\App\Models\Category::all() as $category)
                                                <li>
                                                    <a  href="{{ route('frontend.products.category', $category->id) }}">{{ $category->name }}</a>
                                                    <ul>
                                                        @foreach (\App\Models\SubCategory::where('category_id', $category->id)->get() as $subcategory)
                                                            <li>
                                                                <a
                                                                    href="{{ route('frontend.products.subcategory', $subcategory->id) }}">{{ $subcategory->name }}</a>
                                                                <ul>
                                                                    @foreach (\App\Models\SubSubCategory::where('sub_category_id', $subcategory->id)->get() as $subsubcategory)
                                                                        <li><a
                                                                                href="{{ route('frontend.products.subsubcategory', $subsubcategory->id) }}">{{ $subsubcategory->name }}</a>
                                                                        </li>
                                                                    @endforeach
                                                                </ul>
                                                            </li>
