...
<body>
    <div>
        ...
        @foreach ($receipts as $key => $receipt_social)
            <div style="background: #eceff4;padding: 1.5rem;page-break-after: always;">
                <table>
                    <tr>
                        <td>
                            ...
                            @else
                                <img loading="lazy" src="{{ asset('frontend/images/logo/logo.png') }}" height="100"
                                    style="display:inline-block;">
                            @endif
                        </td>
                    </tr>
            ...
            <table style="padding: 1.5rem;float: right;position: relative;">
                ...
                <tr>
                    ...
                    <td class="text-right small" style="font-size: 1.2rem;padding-bottom:18px">
                        <span>{{ $receipt_social->created_at }}</span> <span
                            class="gry-color strong" style="float:right">: تحرير في </span></td>
                </tr>

                <tr>
                    <td class="text-right small" style="font-size: 1.2rem;padding-bottom:18px"> </td>
                    <td class="text-right small" style="font-size: 1.2rem;padding-bottom:18px">
                        <span>{{ $receipt_social->client_name }}</span> <span class="gry-color strong" style="float:right">:
                            استلمت من السيد</span></td>
                </tr>

                <tr>
                    <td class="text-right small" style="font-size: 1.2rem;padding-bottom:18px"> </td>
                    <td class="text-right small" style="font-size: 1.2rem;padding-bottom:18px"> <span>جنيه</span> <span
                            class="gry-color strong" style="float:right">{{ $receipt_social->deposit }}: مبلغ وقدره</span></td>
                </tr>

                <tr>
                    <td class="text-right small" style="font-size: 1.2rem;padding-bottom:18px"><span> </span> <span
                            class="gry-color strong" style="float:right">...........................................:
                            مسحوب علي بنك</span></td>
                    <td class="text-right small" style="font-size: 1.2rem;padding-bottom:18px"><span> </span> <span
                            class="gry-color strong" style="float:right">...........................................:
                            نقدا / بشيك رقم</span></td>
                </tr>
