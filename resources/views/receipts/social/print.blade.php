        ...
        <div style="page-break-after: always;">
            <div style="padding: 1.5rem;position:relative">
                ...
                <table>
                    <tr>
                        <td>
                                <img loading="lazy" src="{{ asset('receipt_logo.png') }}" height="130"
                                    style="display:inline-block;">
                        </td>
                    </tr>
                </table>
                <div style="position: absolute;right:120px;top:65px;font-size:40px">
                    {!! QrCode::size(75)->generate($receipt_social->order_num) !!}
            ...
            <div id="second_part-{{$receipt_social->id}}" style="position: relative; width:90%;left:40px">
                ...
                <table class="table table-bordered text-center">
                    <tbody>
                        ...
                        <tr>
                            <td>
                                {{ $receipt_social->date_of_receiving_order }}
                            </td>
                            <td colspan="2">
                                تاريخ استلام
                            </td>
                ...
                <table class="table text-center table-borderless" style="width: 270px;float:right">
                    <tr>
                        <td></td>
                        <td>
                        {!! QrCode::size(75)->generate($receipt_social->order_num) !!}</td>
                        <td></td>
                        <td></td>
                    </tr>
                </table>
                ...
                <table class="table table-bordered text-center" style="width: 400px;float:left">
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $receipt_social->send_to_deliver->name ?? '' }}</td>
                            <td>الأرسال للشحن</td>
                        </tr>
                    </tbody>
                </table>
