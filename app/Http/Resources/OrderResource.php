...
class OrderResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        foreach($this->OrderDetails as $key => $order_detail){
            ...
            $description .= $product_name . "(" . $order_detail->quantity .  ") <br> " . $order_detail->description ;
            $description .= '<hr>';
        }
        ...
        return [
            ...
            'send_to_delivery_id' => $this->send_to_delivery_id,
            'printing_times' => $this->printing_times,
        ];
    }
}
